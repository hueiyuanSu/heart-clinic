...
<div class="row">
    <div class="col-md-12">
        <?php $form = ActiveForm::begin(); ?>
            ...
            <!-- meta start -->
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'name_en')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'effects_note')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'ingredient')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'feature')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6">
                <?= $form->field($modelMeta, 'suggestion')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6">
