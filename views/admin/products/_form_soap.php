...
<div class="row">
    <div class="col-md-12">
        <?php $form = ActiveForm::begin(); ?>
            ...
            <!-- meta start -->
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'suitable')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'ingredient')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'weight')->textInput(['maxlength' => true]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'useage')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
                <?= $form->field($modelMeta, 'expiration')->textarea(['rows' => 6]) ?>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4">
